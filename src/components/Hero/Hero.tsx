    ...
    <section className={styles.hero}>
      ...
      <article className={styles.article}>
        <div className={styles.h1s}>
          <h1 className={styles.firstHeading}>Words Float</h1>
          <h1 className={styles.secondHeading}>Like Clouds</h1>
        </div>
        <p className={styles.ptag}>
          Find your reading rhythm. Just as clouds glide across the sky, <br />
          words here flow naturally, inviting a peaceful and profound connection
          with every meaning they carry.
        </p>
      </article>
      <div className={styles.heroButtons}>
        <Button
          type="button"
          text="Catch the Current"
          classname="catchCurrent"
          icon={
            <svg
              className={styles.windSVG}
              viewBox="0 0 24 24"
              fill="currentColor"
              stroke="currentColor"
        ...
        />
        {!logged && (
          <Button type="button" text="Join Readers" classname="joinReaders" />
        )}
      </div>
    </section>
  );
