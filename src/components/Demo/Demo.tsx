    ...
    return(
        <section className={styles.wrapper}>
            <article className={styles.article}>
                <h1 className={styles.title}>{location.pathname == "/read" ? "Enter Your New Text or Upload" : "BeginYour Journey Here"}</h1>
                <p className={styles.content}>
                    Paste your text below or drag a file to start reading.
                </p>
            </article>
            <form action="submit" className={styles.reader} onSubmit={handleSubmit}>
                ...
                <div className={styles.labelError}>
                    ...
                    <div className={styles.error} style ={{visibility: error ? "visible" : "hidden"}}>*You need to paste a text or upload a file</div>
                </div>
